...
/* harmony import */ var color__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(color__WEBPACK_IMPORTED_MODULE_0__);
  ...
  const darkenClr = (fill,val) =>{
    return color__WEBPACK_IMPORTED_MODULE_0___default()(fill,"rgb").darken(val).rgb().object()
  }
  
  const lightenClr = (fill,val) =>{

    let out = color__WEBPACK_IMPORTED_MODULE_0___default()(fill,"rgb").lighten(val).rgb().object()
