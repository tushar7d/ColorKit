...
figma.ui.onmessage = msg => {
    if (msg.type === 'darken') {
        ...
        for (let i = 0; i < msg.count; i++) {
            const cl = (i == 0 ? color : Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["darkenClr"])(color, msg.ratio));
    ...
    if (msg.type === 'lighten') {
        ...
        const cent = figma.viewport.center.x;
        for (let i = 0; i < msg.count; i++) {
            const cl = (i == 0 ? color : Object(_util_js__WEBPACK_IMPORTED_MODULE_0__["lightenClr"])(color, msg.ratio));
            const rect = figma.createRectangle();
            rect.x = (i * 100) + cent;
            rect.fills = [{ type: 'SOLID', color: cl }];
            figma.currentPage.appendChild(rect);
...
/*!*********************!*\
  !*** ./src/util.js ***!
  \*********************/
/*! exports provided: darkenClr, lightenClr */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "darkenClr", function() { return darkenClr; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lightenClr", function() { return lightenClr; });
/* harmony import */ var color__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! color */ "./node_modules/color/index.js");
/* harmony import */ var color__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(color__WEBPACK_IMPORTED_MODULE_0__);

 
  const darkenClr = (fill,val) =>{
    return color__WEBPACK_IMPORTED_MODULE_0___default()(fill).darken(val).rgb().object()
  }
  
  const lightenClr = (fill,val) =>{
    return color__WEBPACK_IMPORTED_MODULE_0___default()(fill).lighten(val).rgb().object()
  }
